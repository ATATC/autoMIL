"""Fixed evaluation and data-loading utilities for CLWD autoresearch.
...
FEATURES_BASE_DIR = "/path/to/features/"
...
BASELINES = {
    "subtype": {"encoder": "hoptimus1", "model": "clam_mb", "test_auc": 0.0},
}
