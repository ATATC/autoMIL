"""Autoresearch MIL: Editable experiment script template.
...
# =========================================================================
TASK = "TODO"                # TODO: set your task name
ENCODER = "TODO_encoder"     # TODO: set your encoder
MODEL_TYPE = "clam_mb"       # TODO: set your model
SEED = 42
...
def train_single_fold(fold: int, device: torch.device) -> dict:
    ...
    model = create_model(
        model_type=MODEL_TYPE, input_dim=input_dim,
        hidden_dim=CONFIG["hidden_dim"], num_classes=2,  # TODO: set num_classes
