...
TODO: Adapt this file for your specific dataset and evaluation needs.
"""
...
# ---------------------------------------------------------------------------
# Project paths - UPDATE THESE FOR YOUR ENVIRONMENT
# ---------------------------------------------------------------------------
PROJECT_ROOT = os.path.dirname(os.path.abspath(__file__))

BENCHMARK_DIR = "/TODO/path/to/benchmark/"
FEATURES_BASE_DIR = "/TODO/path/to/features/"

ENCODER_DIMS: dict[str, int] = {
    "TODO_encoder": 1536,  # TODO: add your encoders and dimensions
}

BASELINES = {
    "TODO": {"encoder": "TODO_encoder", "model": "clam_mb", "test_auc": 0.0},
}
...
def get_plan_path(task: str, encoder: str, strategy: str = "baseline") -> str:
...
def get_splits(
    task: str, strategy: str = "baseline", n_folds: int = N_FOLDS
...
def print_results(
    ...
    if baseline and baseline.get("test_auc", 0) > 0:
