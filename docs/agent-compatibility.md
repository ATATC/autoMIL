...
2. Add `automil/program.md` content to your Cursor rules or system prompt
3. Tell the agent: "Follow the instructions in automil/program.md to run the experiment loop"
...
### Setup
1. Include `automil/program.md` in the agent's context
2. Ensure the agent has shell access to run `automil` commands
3. Start with: "Read automil/program.md and begin the experiment loop"

## Aider

### Setup
1. Start aider in the project directory
2. Use `/read automil/program.md` to load instructions
...
2. Add `automil/program.md` to Cascade context
3. Start the loop

## Universal Requirements

Any compatible agent must be able to:
1. **Read files** - `automil/config.yaml`, `automil/graph.json`, `automil/learnings.md`, `automil/program.md`, and your project's source code
...
- **Files**: `automil/config.yaml`, `automil/graph.json`, `automil/learnings.md` (read); any project source file (edit)
- **CLI**: `automil` commands for all operations
- **`automil/program.md`**: complete instructions for the experiment loop
